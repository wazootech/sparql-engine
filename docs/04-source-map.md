...
| `bgp-evaluator.ts`         | `BgpEvaluatorOptions` L49, `BgpEvaluator` L75, `patternListContainsExists` L812                                                                                                                                                                                                                                                                                                                             | Pattern algebra: group evaluation, OPTIONAL/MINUS/UNION/GRAPH/BIND/VALUES, subqueries, and the synchronous EXISTS evaluator. |
